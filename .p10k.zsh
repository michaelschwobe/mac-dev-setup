# Generated by Powerlevel10k configuration wizard on 2023-07-09 at 13:46 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    pnpm_version            # example user-defined segment (see prompt_pnpm_version function below)
  ...
  function prompt_npm_version() {
    ...
    p10k segment -b 2 -f 0 -i 'npm' -t $npm_version
  }

  ################################[ pnpm_version: pnpm version ]#################################
  function prompt_pnpm_version() {
    local pnpm_version=$(pnpm -v 2>/dev/null)
    [[ -z "${pnpm_version}" ]] && return
    p10k segment -b 3 -f 0 -i 'pnpm' -t $pnpm_version
  }
  ...
  function prompt_yarn_version() {
    ...
    p10k segment -b 5 -f 0 -i 'yarn' -t $yarn_version
  }
