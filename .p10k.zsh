# Generated by Powerlevel10k configuration wizard on 2020-12-17 at 14:45 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    npm_version             # example user-defined segment (see prompt_npm_version function below)
    yarn_version            # example user-defined segment (see prompt_yarn_version function below)
  ...
  function prompt_npm_version() {
    ...
    [[ -z "${npm_version}" ]] && return
    p10k segment -t $npm_version
  }
  # npm version color.
  typeset -g POWERLEVEL9K_NPM_VERSION_FOREGROUND=0
  typeset -g POWERLEVEL9K_NPM_VERSION_BACKGROUND=6
  # Show npm version only when in a directory tree containing package.json.
  typeset -g POWERLEVEL9K_NPM_VERSION_PROJECT_ONLY=true
  # Custom icon.
  typeset -g POWERLEVEL9K_NPM_VERSION_VISUAL_IDENTIFIER_EXPANSION='npm'

  ################################[ yarn_version: yarn version ]################################
  function prompt_yarn_version() {
    local yarn_version=$(yarn -v 2>/dev/null)
    [[ -z "${yarn_version}" ]] && return
    p10k segment -t $yarn_version
  }
  # yarn version color.
  typeset -g POWERLEVEL9K_YARN_VERSION_FOREGROUND=0
  typeset -g POWERLEVEL9K_YARN_VERSION_BACKGROUND=7
  # Show yarn version only when in a directory tree containing package.json.
  typeset -g POWERLEVEL9K_YARN_VERSION_PROJECT_ONLY=true
  # Custom icon.
  typeset -g POWERLEVEL9K_YARN_VERSION_VISUAL_IDENTIFIER_EXPANSION='yarn'
